...
""" Loop over each class and format its image labels """
for cls in classes:
    cls_id = classes.index(cls)

    """ Configure Paths """
    mypath = "/home/riccardo/darknet/labels/" + cls + "/"
    outpath = "/home/riccardo/darknet/labels/" + cls + "_formatted/"

    if not os.path.exists(outpath):
        os.mkdir(outpath)

    wd = "/home/riccardo/darknet"
